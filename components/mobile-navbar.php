 <section class=" container mobile-navbar">
        <div class="header-container">
            ...
            <button id="mobile-xmark">
                <img src="<?php echo BASE_URL; ?>assets/mobile-navbar-xmark.svg">
            </button>
        </div>
        <div class="mobile-navbar-content">
            <ul>
                <a href="<?php echo BASE_URL;?>" class="mobile-navbar-item">
                    <li>
                        <img src="<?php echo BASE_URL; ?>assets/mobile-navbar-house.svg" alt="home icon">Home
                    </li>
                </a>
                ...
                <a href="<?php echo BASE_URL;?>#services" class="mobile-navbar-item">
                    <li>
                        <img src="<?php echo BASE_URL; ?>assets/mobile-navbar-services.svg" alt="home icon">Services
                    </li>
                </a>
                ...
                <li>
                    <button popovertarget="modalUnavailable">
                        ...
                        <img src="<?php echo BASE_URL; ?>assets/mobile-navbar-reviews.svg" alt="home icon">Reviews
                    </button>
                </li>
                <li>
                    <button popovertarget="modalUnavailable">
